...
function Alert(props) {
 ...
 const Add = () => {
   ...
   const [openAlert, setOpenAlert] = useState(folse);
    ...
    <Container className={classes.container}>
      <form className={classes.form} autoComplete="off">
        <div className={classes.item}>
          <TextField id="standard-basic" label="Title" size="small" style={{width: "85%"}}/>
        </div>
        <div className={classes.item}>
          ...
          variant="outlined"
          label="Description" size="small" style={{width: "85%"}}/>
        </div>
        <div className={classes.item}>
        ...
        <div className={classes.item}>
          ...
          <Button variant="outlined" color="secondary" onClick={() => setOpen(folse)}>
            Cancel
          </Button>
        </div>
      </form>
  ...
  <Snackbar open={openAlert} autoHideDuration={6000} onClose={handleClose}>
        <Alert onClose={handleClose} severity="success">
         Sindenze x? cg nturemera? hhhhhh!
        </Alert>
      </Snackbar>
  </>
  );
